...
class MessagesController < ApplicationController
   ...
   def list
      ...
      if ( session[ :forum_id ]== nil ) # if no forum_id is provided
         ...
         redirect_to :controller => "forum", :action => "list" and return
      end # if
   ...
   # sets up the new web page that creates a messages
   def new
      @message = Message.new
   end # end method new
