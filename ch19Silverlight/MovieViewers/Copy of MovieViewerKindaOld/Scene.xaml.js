...
var volumeHead;
var baileyButton;
var featherAndHammerButton;
var apollo15LaunchButton;
var F35Button;
var baileyButtonText;
var featherAndHammerButtonText;
var apollo15LaunchButtonText;
var F35ButtonText;
...
function canvasLoaded( sender, eventArgs )
{
   ...
   baileyButton = sender.findName( "baileyButton" );
   featherAndHammerButton = sender.findName( "featherAndHammerButton" );
   apollo15LaunchButton = sender.findName( "apollo15LaunchButton" );
   F35Button = sender.findName( "F35Button" );
   baileyButtonText = sender.findName( "baileyButtonText" );
   featherAndHammerButtonText = sender.findName( "featherAndHammerButtonText" );
   apollo15LaunchButtonText = sender.findName( "apollo15LaunchButtonText" );
...
function movieThumbHandler ( sender, eventArgs )
{
   ...
   baileyButtonText.Foreground = "white";
   featherAndHammerButtonText.Foreground = "white";
   apollo15LaunchButtonText.Foreground = "white";
   ...
   switch (sender.name)
   {
      case "baileyButton":
         ...
         baileyButtonText.Foreground = "red"; // indicate this is selected
         break;
      case "featherAndHammerButton":
         movieMediaElement.source = "featherAndHammer.wmv"; // open Bailey video
         featherAndHammerButtonText.Foreground = "red"; // indicate this is selected
         break;
      case "apollo15LaunchButton":
         movieMediaElement.source = "apollo15Launch.wmv"; // open Bailey video
         apollo15LaunchButtonText.Foreground = "red"; // indicate this is selected
         break;
      case "F35Button":
