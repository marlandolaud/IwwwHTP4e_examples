 ...
 * generated in the reservationservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _Reserve_QNAME = new QName("http://reservation.ch28.iw3htp4.deitel.com/", "reserve");
    private final static QName _ReserveResponse_QNAME = new QName("http://reservation.ch28.iw3htp4.deitel.com/", "reserveResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: reservationservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://reservation.ch28.iw3htp4.deitel.com/", name = "reserve")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://reservation.ch28.iw3htp4.deitel.com/", name = "reserveResponse")
